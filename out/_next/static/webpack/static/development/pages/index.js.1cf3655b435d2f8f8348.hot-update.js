...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submitEventForm", function (values, actions) {
      ...
      var uniqeName = "".concat(value.name, " ").concat(Date.now());
      values.lastUpdated = new Date();
      values.id = uniqeName;
      firestore.collection("events").doc(uniqeName).set(values); /////calles
...
//# sourceMappingURL=index.js.1cf3655b435d2f8f8348.hot-update.js.map