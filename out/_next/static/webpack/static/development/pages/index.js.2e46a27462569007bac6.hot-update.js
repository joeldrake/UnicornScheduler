...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "submitEventForm", function (values, actions) {
      ...
      values.id = eventname;
      firestore.collection("events").doc().set(values); /////calles
...
//# sourceMappingURL=index.js.2e46a27462569007bac6.hot-update.js.map